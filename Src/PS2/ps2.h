...
#define DO_H	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_13,GPIO_PIN_SET)		//命令位高
#define DO_L	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_13,GPIO_PIN_RESET)		//命令位低

//#define CS_H PBout(14)=1       //CS拉高
//#define CS_L PBout(14)=0       //CS拉低

#define CS_H	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_SET)		//CS位高
#define CS_L	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_RESET)		//CS位低
